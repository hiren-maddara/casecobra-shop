...
function Review({ imgSrc, className, ...props }: ReviewProps) {
    ...
    return <div className={cn("animate-fade-in rounded-[2.25rem] bg-white p-6 opacity-0 shadow-xl shadow-slate-900/50", className)} style={{ animationDelay }} {...props}>
        <Phone imgSrc={imgSrc} />
    </div>
}
...
export default function Reviews() {
    return (
        <MaxWidthWrapper className="relative max-w-5xl">
            <img alt="" aria-hidden="true" src="/what-people-are-buying.png" className="absolute select-none xl:block -left-32 top-1/3" />
