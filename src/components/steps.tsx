...
export function Steps() {
    ...
    return <ol className="rounded-md bg-white lg:flex lg:rounded-none lg:border-l lg:border-r lg:border-gray-200">
        {STEPS.map((step, i) => {
            ...
            return <li className="relative overflow-hidden lg:flex-1" key={step.name}>
                <div>
                    ...
                    <span className={cn(i !== 0 ? 'lg:pl-9' : '', 'flex items-center px-6 py-4 text-sm font-medium')}>
                        <span
                            ...
                            <img
                                alt=""
                                src={imgPath} className={cn("flex h-20 w-20 object-contain items-center justify-center", {
